...
class QdrantOutput(DynamicSink):
    ...
    def build(self, worker_index: int, worker_count: int, resume_epoch=None, resume_step=None) -> StatelessSinkPartition:
        """Build method that returns a StatelessSinkPartition.
        
        This method signature matches bytewax 0.21.1 expectations.
        
        Args:
            worker_index: The index of the worker.
            worker_count: The total number of workers.
            resume_epoch: The epoch to resume from.
            resume_step: The step to resume from.
            
        Returns:
            StatelessSinkPartition: A partition of the sink.
        """
